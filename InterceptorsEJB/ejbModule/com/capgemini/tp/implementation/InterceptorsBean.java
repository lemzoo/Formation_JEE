 ...
 */
@Stateless
//@Interceptors(Auditor.class) => Default interceptors
/* L'interceptor fonctionne comme un filtre de Servlet */
public class InterceptorsBean implements InterceptorsBeanRemote {
	...
	public Object methodStats(InvocationContext invctx) throws Exception {
		...
		System.out.println("Starting method Interceptors : " + name);
		try {
			return invctx.proceed();
		} finally {
			long elapsedTime = System.nanoTime() - startTime;
			System.out.println("Finished method Interceptors : " + name + " Method took " + elapsedTime + " nanoseconds to execute");
		}
	}
